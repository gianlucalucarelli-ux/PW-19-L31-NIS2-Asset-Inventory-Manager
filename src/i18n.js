...
const ENGLISH_TRANSLATIONS = new Map(Object.entries({
    ...
    'Applicazione web per censire soggetti NIS2, asset, servizi, fornitori e dipendenze, rappresentare la Supply Chain, gestire gli incidenti e valutare i Profili Target e Attuale secondo il FNCSDP.': 'Web application for recording NIS2 entities, assets, services, suppliers and dependencies, mapping the supply chain, managing incidents, and assessing Target and Current Profiles according to the FNCSDP.',
    'Candidato': 'Candidate',
    ...
    'Consultazione e gestione controllata di soggetti NIS2, asset, servizi, persone e responsabilità, con criticità, versioni e tracciamento delle modifiche.': 'Controlled management of NIS2 entities, assets, services, people and responsibilities, including criticality, versions and change tracking.',
    'Dipendenze e Supply Chain': 'Dependencies and supply chain',
    'Rappresentazione delle relazioni tra servizi, asset, fornitori e subfornitori, predisposta per percorsi multilivello e analisi delle dipendenze.': 'Representation of relationships among services, assets, suppliers and subcontractors, designed for multi-level paths and dependency analysis.',
    'Sicurezza e tracciabilità': 'Security and traceability',
    'Autenticazione Supabase, MFA, policy RLS, Audit Log, gestione guidata degli incidenti e Assessment dei Profili Target e Attuale secondo il FNCSDP.': 'Supabase authentication, MFA, RLS policies, audit log, guided incident management, and assessment of Target and Current Profiles according to the FNCSDP.',
    ...
    'SICUREZZA E CONFORMITÀ': 'SECURITY AND COMPLIANCE',
    'Assessment FNCSDP': 'FNCSDP Assessment',
    'CYBERSECURITY ASSESSMENT': 'CYBERSECURITY ASSESSMENT',
    'Profili Target e Attuale FNCSDP': 'FNCSDP Target and Current Profiles',
    'Definisci la postura desiderata, misura copertura e maturità dei controlli e valuta il gap. Il modulo utilizza le Subcategory Asset Management ID.AM-1–ID.AM-6 coerenti con il perimetro del Project Work.': 'Define the desired posture, measure control coverage and maturity, and assess the gap. The module uses Asset Management Subcategories ID.AM-1–ID.AM-6, consistent with the Project Work scope.',
    '1 · Contestualizzazione': '1 · Contextualisation',
    '2 · Misura': '2 · Measurement',
    '3 · Valutazione': '3 · Evaluation',
    'Profili Target': 'Target Profiles',
    'Obiettivo di sicurezza desiderato per il soggetto NIS2.': 'Desired security objective for the NIS2 entity.',
    'Nuovo Profilo Target': 'New Target Profile',
    'Profilo Target selezionato': 'Selected Target Profile',
    'Approva Target': 'Approve Target',
    'Target approvato': 'Target approved',
    'Assessment e Profili Attuali': 'Assessments and Current Profiles',
    'Nuovo assessment': 'New assessment',
    'Profilo Attuale': 'Current Profile',
    'Esporta XLSX': 'Export XLSX',
    'Completa assessment': 'Complete assessment',
    'Assessment completato': 'Assessment completed',
    'Avanzamento': 'Progress',
    'Score': 'Score',
    'Gap': 'Gap',
    'Maturità media indicativa': 'Indicative average maturity',
    'Controllo': 'Control',
    'Subcategory': 'Subcategory',
    'Copertura attuale': 'Current coverage',
    'Maturità': 'Maturity',
    'Stato misura': 'Measurement status',
    'CONTESTUALIZZAZIONE': 'CONTEXTUALISATION',
    'Il sistema genera sei controlli iniziali collegati alle Subcategory ID.AM-1–ID.AM-6.': 'The system generates six initial controls linked to Subcategories ID.AM-1–ID.AM-6.',
    'Perimetro': 'Scope',
    'Crea Profilo Target': 'Create Target Profile',
    'MISURA': 'MEASUREMENT',
    'Data assessment': 'Assessment date',
    'Assessor': 'Assessor',
    'Crea assessment': 'Create assessment',
    'MISURA DEL CONTROLLO': 'CONTROL MEASUREMENT',
    'Compila misura': 'Enter measurement',
    'Risposta dell’intervistato': 'Interviewee response',
    'Grado di copertura': 'Coverage level',
    'Livello di maturità CMMI': 'CMMI maturity level',
    'Note sulla copertura': 'Coverage notes',
    'Note sulla maturità': 'Maturity notes',
    'Evidenze': 'Evidence',
    'Ulteriori note dell’assessor': 'Additional assessor notes',
    'Salva misura': 'Save measurement',
    'Non misurata': 'Not measured',
    'Da compilare': 'To complete',
    'Completa': 'Complete',
    'Compila': 'Enter',
    'Supporto': 'Support',
    'SUPPORTO': 'SUPPORT',
    ...
    'RINGRAZIAMENTI': 'ACKNOWLEDGEMENTS',
    'UN PERCORSO CONDIVISO': 'A SHARED JOURNEY',
    'Questo Project Work è il risultato di un percorso di studio, impegno e crescita personale.': 'This Project Work is the result of a journey of study, commitment and personal growth.',
    'Desidero esprimere la mia gratitudine alle persone e alle realtà che hanno accompagnato e sostenuto questo percorso.': 'I would like to express my gratitude to the people and institutions that supported and accompanied this journey.',
    'Università Telematica Pegaso': 'Pegaso Online University',
    'Per gli insegnamenti, gli strumenti e le opportunità formative ricevute durante il corso di laurea.': 'For the teaching, tools and learning opportunities received throughout the degree programme.',
    'Cristina e Mattia': 'Cristina and Mattia',
    'Alla mia compagna Cristina, per il supporto, la pazienza e per aver creduto in me, insieme a mio figlio Mattia.': 'To my partner Cristina, for her support, patience and belief in me, together with my son Mattia.',
    'Maestro Alessandro D’ORIA': 'Master Alessandro D’ORIA',
    'Al mio Maestro del Tempio del Tai Chi, per gli insegnamenti, la disciplina e l’ispirazione che hanno accompagnato anche questo percorso.': 'To my Master from the Tempio del Tai Chi, for the teachings, discipline and inspiration that also accompanied this journey.',
    ...
    'Tracciamento storico, accessi al database, ricerca ed esportazione delle operazioni applicative.': 'Historical tracking, database access events, search and export of application operations.',
    'Ricerca libera': 'Free-text search',
    'Record, utente, asset, servizio o fornitore': 'Record, user, asset, service or supplier',
    'Record, utente, entità, asset, servizio o fornitore': 'Record, user, entity, asset, service or supplier',
    'Tabella': 'Table',
    ...
    'Entità': 'Entity',
    'Entità applicativa': 'Application entity',
    'Gerarchia': 'Hierarchy',
    ...
    'Finalità': 'Purpose',
    'L\'applicazione supporta il censimento dei soggetti NIS2, delle persone e degli incarichi, degli asset, dei servizi, dei fornitori e delle relative dipendenze. Consente inoltre la gestione degli incidenti e degli Assessment FNCSDP.': 'The application supports the registration of NIS2 entities, people and appointments, assets, services, suppliers and their dependencies. It also supports incident management and FNCSDP assessments.',
    'Architettura': 'Architecture',
    'Frontend modulare HTML5, CSS e JavaScript pubblicato su GitHub Pages e integrato con PostgreSQL/Supabase. Il backend comprende 36 tabelle in 3FN, 11 viste principali, API dati, autenticazione e policy RLS.': 'Modular HTML5, CSS and JavaScript frontend published on GitHub Pages and integrated with PostgreSQL/Supabase. The backend includes 36 tables in 3NF, 11 main views, data APIs, authentication and RLS policies.',
    'L\'accesso ai dati è controllato tramite sessione autenticata, livelli AAL/MFA, privilegi PostgreSQL e Row Level Security. Le operazioni sono registrate nell\'Audit Log; le cancellazioni fisiche sono bloccate e sostituite dall\'archiviazione logica.': 'Data access is controlled through authenticated sessions, AAL/MFA levels, PostgreSQL privileges and Row Level Security. Operations are recorded in the Audit Log; physical deletion is blocked and replaced by logical archiving.',
    'Project Work': 'Project Work',
    'Progetto sviluppato per il corso di Informatica per le aziende digitali L-31. Integra inventario NIS2, Supply Chain, gestione degli incidenti e valutazione dei Profili Target e Attuale secondo la metodologia FNCSDP.': 'Project developed for the L-31 Computer Science for Digital Businesses degree programme. It integrates NIS2 inventory, supply chain, incident management, and assessment of Target and Current Profiles according to the FNCSDP methodology.',
    'Percorso operativo': 'Operational workflow',
    'Soggetti NIS2 → Inventario → Servizi e fornitori → Relazioni e Supply Chain → Incidenti → Assessment FNCSDP → Audit Log ed esportazioni.': 'NIS2 entities → Inventory → Services and suppliers → Relationships and supply chain → Incidents → FNCSDP Assessment → Audit Log and exports.',
