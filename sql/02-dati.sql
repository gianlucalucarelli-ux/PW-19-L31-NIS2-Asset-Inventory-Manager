-- =========================================================================
-- FILE: sql/02-dati.sql (VERSIONE CORRETTA - COMPILAZIONE DEFINITIVA)
-- Descrizione: Dataset di popolamento conforme alle 9 tabelle core 3NF.
-- OBIETTIVO: Risoluzione errore sintattico su colonna "servizio_id"
-- =========================================================================
...
-- 5. ASSOCIAZIONE RESPONSABILI - RUOLI (Tabella N:M)
...
-- 9. POPOLAMENTO DIPENDENZE INFRASTRUTTURALI (FIX SINTATTICO CON "servizio_id")
